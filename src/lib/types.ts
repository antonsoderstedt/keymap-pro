...
export const MARKET_OPTIONS = [
  ...
  // Sverige med språkvarianter (behåll bakåtkompatibilitet)
  { value: "se-sv", label: "Sverige / Svenska" },
  { value: "se-en", label: "Sverige / Engelska" },
  // Länder (ISO 3166-1 alpha-2, gemener)
  ...
  { value: "nz", label: "Nya Zeeland" },
  { value: "no", label: "Norge" },
  { value: "ph", label: "Filippinerna" },
  { value: "pl", label: "Polen" },
  { value: "pt", label: "Portugal" },
  { value: "ro", label: "Rumänien" },
  { value: "sa", label: "Saudiarabien" },
  { value: "rs", label: "Serbien" },
  { value: "sg", label: "Singapore" },
  { value: "sk", label: "Slovakien" },
  ...
  { value: "ae", label: "Förenade Arabemiraten" },
